...
class Contato_new extends CI_Controller 
{
	 ...
	 * Sessions do tipo flashdata-> representam carregamento por impulso, 
	 * isto é, ao mudar de página ou recarregando a página automaticamente são excluidas de memória.
	 */
